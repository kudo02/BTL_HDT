...
public class Final_result_python extends AppCompatActivity {
    private TextView tvCorrect, tvIncorrect, tvScore,tvDate;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_final_result_python);
        ...
        sb.append(question_python.correct + "\n");
        StringBuffer sb2 = new StringBuffer();
        sb2.append(question_python.wrong + "\n");
        StringBuffer sb3 = new StringBuffer();
        sb3.append(question_python.correct + "\n");
        tvCorrect.setText(sb);
        tvIncorrect.setText(sb2);
        tvScore.setText(sb3);
        tvDate.setText(Utils.formatDate(Calendar.getInstance().getTimeInMillis()));

        question_python.correct=0;
        question_python.wrong=0;

        findViewById(R.id.imageViewFinalResultQuiz).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Final_result_python.this,MainActivity.class);
